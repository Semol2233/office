...
class duebill(ListView):
    ...
    def get_context_data(self, **kwargs):
         ...
         context['idoff'] = monthlybill.objects.filter(payment_status=False,month__month__startswith=month,description__iexact="#idoff").exclude(activities__act_line__startswith="declined")
