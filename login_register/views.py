...
class daulycost_list(LoginRequiredMixin,ListView):
    ...
    queryset = dailybilling.objects.filter(date__gte=datetime.now()-timedelta(days=31)).exclude(cost_profile__cost_name__contains='Advance salary')
...
class OFFICE_COST(LoginRequiredMixin,ListView):
    ...
    queryset = dailybilling.objects.filter(cost_profile__cost_name__contains='Office Cost',date__gte=datetime.now()-timedelta(days=31))
...
class OFFICE_family(LoginRequiredMixin,ListView):
    ...
    model = dailybilling
    template_name= 'goninda/cost.html'
    queryset = dailybilling.objects.filter(cost_profile__cost_name__contains='Family',date__gte=datetime.now()-timedelta(days=31))
...
class OFFICE_product(LoginRequiredMixin,ListView):
    ...
    model = dailybilling
    template_name= 'goninda/cost.html'
    queryset = dailybilling.objects.filter(cost_profile__cost_name__contains='Product Cost',date__gte=datetime.now()-timedelta(days=31))
...
class OFFICE_salllery(LoginRequiredMixin,ListView):
    ...
    model = dailybilling
    template_name= 'goninda/cost.html'
    queryset = dailybilling.objects.filter(cost_profile__cost_name__contains='Salary',date__gte=datetime.now()-timedelta(days=31))
...
class OFFICE_trnasportcost(LoginRequiredMixin,ListView):
    ...
    model = dailybilling
    template_name= 'goninda/cost.html'
    queryset = dailybilling.objects.filter(cost_profile__cost_name__contains='Transport Cost',date__gte=datetime.now()-timedelta(days=31))
...
class OFFICE_Chika(LoginRequiredMixin,ListView):
    ...
    model = dailybilling
    template_name= 'goninda/cost.html'
    queryset = dailybilling.objects.filter(cost_profile__cost_name__contains='Chika',date__gte=datetime.now()-timedelta(days=31))
...
class OFFICE_internetbill(LoginRequiredMixin,ListView):
    ...
    model = dailybilling
    template_name= 'goninda/cost.html'
    queryset = dailybilling.objects.filter(cost_profile__cost_name__contains='Orange',date__gte=datetime.now()-timedelta(days=31))
...
class OFFICE_Electric(LoginRequiredMixin,ListView):
    ...
    model = dailybilling
    template_name= 'goninda/cost.html'
    queryset = dailybilling.objects.filter(cost_profile__cost_name__contains='Electric Cost',date__gte=datetime.now()-timedelta(days=31))
...
class OFFICE_Employ(LoginRequiredMixin,ListView):
    ...
    model = dailybilling
    template_name= 'goninda/cost.html'
    queryset = dailybilling.objects.filter(cost_profile__cost_name__contains='Employ Cost',date__gte=datetime.now()-timedelta(days=31))
...
class OFFICE_Pickup(LoginRequiredMixin,ListView):
    ...
    model = dailybilling
    template_name= 'goninda/cost.html'
    queryset = dailybilling.objects.filter(cost_profile__cost_name__contains='Pickup Cost',date__gte=datetime.now()-timedelta(days=31))
