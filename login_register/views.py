...
class area_bill(LoginRequiredMixin,ListView):
    ...
    def get_context_data(self, **kwargs):
         ...
         context['homeuser'] = monthlybill.objects.filter(Bill_collection_type__area_col__startswith="Collect_home").exclude(activities__act_line__startswith="declined").count()
         return context    