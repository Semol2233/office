...
class SFSF(ListView):
    ...
    def get_context_data(self, **kwargs):
         ...
         test2 = Bill_collection_type__collection__startswith="Collect_home"
         context['unpaidwuser'] = monthlybill.objects.filter(payment_status=False,month__month__startswith=month).exclude(test,test2)
